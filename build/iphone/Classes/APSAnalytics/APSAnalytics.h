 ...
 * to send analytic data that can be viewed on the Clima Dashboard.
 *
 * For information on getting started with Clima Platform Services,
 * see [Clima Platform Services for iOS](http://bit.ly/1kqteQS).
 */
